...
class SHADOWLive:
    ...
    def plugin_say(self, instruction: str) -> None:
        """
        Thread-safe speech channel for plugins: lets a plugin ask SHADOW to
    ...
    def _build_config(self) -> types.LiveConnectConfig:
        ...
        cfg = dict(
            ...
            # window — SHADOW can stay in one conversation for hours
        ...
        if self._enhanced_live:
            # Affective dialog: SHADOW hears tone/emotion and adapts its voice.
            # Proactive audio: SHADOW stays silent when speech isn't addressed
